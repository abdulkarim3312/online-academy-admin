    ...
    <div class="col_12">
      <div class="card no_border">
        <div class="card-header">
          <div class="card-title">Course Requirement List</div>
        </div>
            ...
            <div class="col_12">
              <div class="d_flex_btwn pt_20 pb_20">
                ...
                <div class="d_flex_end col_6 pr_0">
                  <router-link
                    :to="{ name: 'course_requirement_add' }"
                    class="btn btn_transparent"
                    >Add Requirement</router-link
                  >
                </div>
              </div>
            </div>
          ...
          >
            ...
            <template #action="{ row }">
              <div class="d_flex_center table_action_btn">
                <router-link
                  :to="{ name: 'course_requirement_edit', params: { id: row.id } }"
                  :title="$t('common.edit')"
    ...
    deleteRecord(row) {
      this.$swal({
        ...
        if (result.isConfirmed) {
          this.axios.delete('/requirements/' + row.id).then(() => {
            this.loadData();
            this.$swal.fire(
