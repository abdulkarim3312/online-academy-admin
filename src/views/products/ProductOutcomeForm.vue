            ...
            <div class="row">
              ...
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('sub_title')}]">
                  <label>Outcome Sub Title</label>
                  <input type="text" class="form_global" v-model="form.sub_title">
                  <v-errors :errors="errorFor('sub_title')" />
                </div>
              </div>
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('outcome_one')}]">
                  <label>Outcome One</label>
                  <input type="text" class="form_global" v-model="form.outcome_one">
                  <v-errors :errors="errorFor('outcome_one')" />
                </div>
              </div>
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('outcome_two')}]">
                  <label>Outcome Two</label>
                  <input type="text" class="form_global" v-model="form.outcome_two">
                  <v-errors :errors="errorFor('outcome_two')" />
                </div>
              </div>
              ...
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('note')}]">
                  <label>Note</label>
                    ...
                    :id="'note'" 
                    :descriptive="''"
                    :existingData="form.note ? form.note : ''" 
...
export default {
  ...
  created() {
    this.axios.get('/product-outcome-data', this.form)
          .then((response) => {
  ...
  methods: {
    ...
    submit() {
      ...
      let formData = new FormData();
        ...
        this.axios.post('/product-outcome', formData, {
            headers: {
