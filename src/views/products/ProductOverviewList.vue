    ...
    <div class="col_12">
      <div class="card no_border">
        <div class="card-header">
          <div class="card-title">Product Overview List</div>
        </div>
        <div class="card-body pl_0 pr_0">
                ...
                <div class="d_flex_start">
                  <div class="dropdown custom_dropdown mr_10">
                    ...
                    <div class="dropdown_menu">
                      <ul>
                        <li @click="changePackageTypeFilter('all')">
                          <a role="button">{{ $t('common.all') }}</a>
                        </li>
                        <li @click="changePackageTypeFilter('one-time')">
                          <a role="button">{{
                            $t('sidebar.packageManagement.one_time_package')
                          }}</a>
                        </li>
                        <li @click="changePackageTypeFilter('subscription')">
                          <a role="button">{{
                            $t('sidebar.packageManagement.subscription_package')
                          }}</a>
                        </li>
                      </ul>
                    </div>
              ...
              <div class="form-group">
                ...
                <div class="d_flex_start">
                  <div class="dropdown custom_dropdown mr_10">
                    ...
                    <div class="dropdown_menu">
                      <ul>
                        <li @click="changeClassificationFilter('all')">
                          <a role="button">{{ $t('common.all') }}</a>
                        </li>
                        <li
                          @click="changeClassificationFilter('general-product')"
                        >
                          <a role="button">{{
                            $t('sidebar.packageManagement.general_product')
                          }}</a>
                        </li>
                        <li
                          @click="
                            changeClassificationFilter('limited-time-product')
                          "
                        >
                          <a role="button">{{
                            $t('sidebar.packageManagement.limited_time_product')
                          }}</a>
                        </li>
                      </ul>
                    </div>
              ...
              <div class="form-group">
                ...
                <div class="d_flex_start">
                  <div class="dropdown custom_dropdown mr_10">
                    ...
                    <div class="dropdown_menu">
                      <ul>
                        <li @click="changeStatusFilter('all')">
                          <a role="button">{{ $t('common.all') }}</a>
                        </li>
                        <li @click="changeStatusFilter('active')">
                          <a role="button">{{ $t('common.active') }}</a>
                        </li>
                        <li @click="changeStatusFilter('inactive')">
                          <a role="button">{{ $t('common.inactive') }}</a>
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div class="col_12">
              <div class="d_flex_btwn pt_20 pb_20">
                ...
                <div class="d_flex_end col_6 pr_0">
                  <router-link
                    :to="{ name: 'product_overview_add' }"
                    class="btn btn_transparent"
                    >Add Product Overview</router-link
                  >
                </div>
              </div>
            </div>
          ...
          >
            <template #price_formated="{ row }">
              <td>{{ row.price_formated }} 원</td>
            </template>
            <template #action="{ row }">
              <div class="d_flex_center table_action_btn">
                <router-link
                  :to="{ name: 'package_edit', params: { id: row.id } }"
                  :title="$t('common.edit')"
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        {
          label: this.$t('sidebar.packageManagement.package_name'),
          field: 'package_name',
          sortable: true,
        },
        {
          label: this.$t('sidebar.packageManagement.package_code'),
          field: 'package_code',
          sortable: true,
        },
        {
          label: this.$t('sidebar.packageManagement.package_type'),
          field: 'formatted_package_type',
          sortable: false,
        },
        {
          label: this.$t('sidebar.packageManagement.classification'),
          field: 'formatted_classification',
          sortable: false,
        },
        {
          label: this.$t('sidebar.packageManagement.service_period'),
          field: 'service_months',
          sortable: false,
          slot: false,
        },
        {
          label: this.$t('sidebar.packageManagement.service_start_date'),
          field: 'service_start',
          sortable: true,
        },
        {
          label: this.$t('sidebar.packageManagement.service_end_date'),
          field: 'service_end',
          sortable: true,
        },
        {
          label: this.$t('sidebar.packageManagement.sale_price'),
          field: 'price_formated',
          sortable: false,
          slot: true,
        },
        // {
        //   label: this.$t('sidebar.packageManagement.discount_price'),
        //   field: "discount_price",
        //   sortable: true
        // },
        // {
        //   label: this.$t('discount_rate'),
  ...
  methods: {
    ...
    changeClassificationFilter(classification) {
      ...
      if (classification == 'general-product') {
        this.filter2.classification = this.$t(
          'sidebar.packageManagement.general_product'
        );
      }
      if (classification == 'limited-time-product') {
        this.filter2.classification = this.$t(
          'sidebar.packageManagement.limited_time_product'
        );
      }
    ...
    changePackageTypeFilter(package_type) {
      ...
      if (package_type == 'one-time') {
        this.filter2.package_type = this.$t(
          'sidebar.packageManagement.one_time_package'
        );
      }
      if (package_type == 'subscription') {
        this.filter2.package_type = this.$t(
          'sidebar.packageManagement.subscription_package'
        );
      }
