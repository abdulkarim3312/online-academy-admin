    ...
    <div class="col_12">
      <div class="card no_border">
        <div class="card-header">
          <div class="card-title">Product Overview Content List</div>
        </div>
        <div class="card-body pl_0 pr_0">
            ...
            <div class="col_12">
              <div class="d_flex_btwn pt_20 pb_20">
                ...
                <div class="d_flex_end col_6 pr_0">
                  <router-link
                    :to="{ name: 'product_overview_content_add' }"
                    class="btn btn_transparent"
                    >Add Product Overview Content</router-link
                  >
                </div>
              </div>
            </div>
          ...
          >
            <template #short_description="{ row }">
              <td>
                <div class="text_shorten" v-html="row.short_description"></div>
              </td>
            </template>
            <template #action="{ row }">
              <div class="d_flex_center table_action_btn">
                <router-link
                  :to="{ name: 'product_overview_content_edit', params: { id: row.id } }"
                  :title="$t('common.edit')"
    ...
    deleteRecord(row) {
      this.$swal({
        ...
        if (result.isConfirmed) {
          this.axios.delete('/product-content-overview/' + row.id).then(() => {
            this.loadData();
            this.$swal.fire(
