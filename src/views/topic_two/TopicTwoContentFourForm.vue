      ...
      <div :class="['col_12', {'loading_overlay': loading}]">
        <div class="card no_border">
          <div class="card-header">
            <div class="card-title">Topic Two Content Four</div>
          </div>
          <div class="card-body pl_0 pr_0">
            <div class="row">
              ...
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('term_one_sub_title')}]">
                  <label>Term One Sub Title</label>
                  <input type="text" class="form_global" v-model="form.term_one_sub_title">
                  <v-errors :errors="errorFor('term_one_sub_title')" />
                </div>
              </div>
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('term_one_content_one')}]">
                  <label>Term One Content One</label>
                  <text-editor-component 
                    :id="'term_one_content_one'" 
                    :descriptive="''"
                    :existingData="form.term_one_content_one ? form.term_one_content_one : ''" 
                    @change="changeEditorValue"
                    />
                    <v-errors :errors="errorFor('term_one_content_one')"></v-errors>
                </div>
              </div>
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('term_one_content_two')}]">
                  <label>Term One Content Two</label>
                  <text-editor-component 
                    :id="'term_one_content_two'" 
                    :descriptive="''"
                    :existingData="form.term_one_content_two ? form.term_one_content_two : ''" 
                    @change="changeEditorValue"
                    />
                    <v-errors :errors="errorFor('term_one_content_two')"></v-errors>
                </div>
              </div>
              <div class="col_6">
              ...
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('term_two_sub_title')}]">
                  <label>Term Two Sub Title</label>
                  <input type="text" class="form_global" v-model="form.term_two_sub_title">
                  <v-errors :errors="errorFor('term_two_sub_title')" />
                </div>
              </div>
              <div class="col_12">
              ...
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('term_three_sub_title')}]">
                  <label>Term Three Sub Title</label>
                  <input type="text" class="form_global" v-model="form.term_three_sub_title">
                  <v-errors :errors="errorFor('term_three_sub_title')" />
                </div>
              </div>
              <div class="col_12">
              ...
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('term_four_sub_title')}]">
                  <label>Term Four Sub Title</label>
                  <input type="text" class="form_global" v-model="form.term_four_sub_title">
                  <v-errors :errors="errorFor('term_four_sub_title')" />
                </div>
              </div>
              <div class="col_12">
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        ...
        term_one_title: '',
        term_one_sub_title: '',
        term_one_content_one: '',
        term_one_content_two: '',
        term_two_title: '',
        term_two_sub_title: '',
        term_two_content: '',
        term_three_title: '',
        term_three_sub_title: '',
        term_three_content: '',
        term_four_title: '',
        term_four_sub_title: '',
        term_four_content: '',
  ...
  created() {
    this.axios.get('/topic-two-content-four-data', this.form)
      .then((response) => {
        if(response.data){
  ...
  methods: {
    ...
    submit() {
      ...
      this.axios.post('/topic-two-content-four', this.form)
        .then(() => {
