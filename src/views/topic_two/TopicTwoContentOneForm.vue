        ...
        <div class="card no_border">
          ...
          <div class="card-body pl_0 pr_0">
            <div class="row">
              ...
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('details_one')}]">
                  <label>Details One</label>
                  <input type="text" class="form_global" v-model="form.details_one">
                  <v-errors :errors="errorFor('details_one')" />
                </div>
              </div>
              ...
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('details_two')}]">
                  <label>Details Two</label>
                  <input type="text" class="form_global" v-model="form.details_two">
                  <v-errors :errors="errorFor('details_two')" />
                </div>
              </div>
              <div class="col_6">
                <div :class="['form-group', {'has_error': errorFor('details_three')}]">
                  <label>Details Three</label>
                  <input type="text" class="form_global" v-model="form.details_three">
                  <v-errors :errors="errorFor('details_three')" />
                </div>
              </div>
...
export default {
  ...
  created() {
    this.axios.get('/topic-two-content-one-data', this.form)
      .then((response) => {
        if(response.data){
  ...
  methods: {
    ...
    submit() {
      ...
      this.axios.post('/topic-two-content-one', formData, {
          headers: {
